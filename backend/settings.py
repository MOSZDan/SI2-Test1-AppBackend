...
# Limpiar ALLOWED_HOSTS removiendo protocolos
raw_hosts = _csv_env("ALLOWED_HOSTS", ["127.0.0.1", "localhost", "si2-test1-appbackend.onrender.com"])
ALLOWED_HOSTS = [host.replace("https://", "").replace("http://", "") for host in raw_hosts]
